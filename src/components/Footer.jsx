    ...
    <footer className="footer-container">
      <div className="footer-top">
        <div className="footer-grid">
          ...
          <div className="footer-col footer-about">
            <a href="#/" className="footer-logo">
              <div className="footer-logo-circle">
                <img src={logo} alt="Shri Kanchan Trust Logo" className="footer-logo-img" />
              </div>
              <span className="footer-brand">Shri Kanchan</span>
            </a>
            <p className="footer-desc">
              Rajasthan's first free dialysis centre — a unit of Shri Krishan Kanchan
              Sewa Trust, dedicated to providing life-saving renal care to those who
              need it most, at no cost.
            </p>
          ...
          <div className="footer-col">
            <h4 className="footer-heading">Support &amp; Donate</h4>
            <ul className="footer-links">
              <li><a href="#/donate">Donate Online</a></li>
              <li><a href="#/donate">Bank Transfer / UPI</a></li>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-contact">
              <li>
                ...
                <span>29, Janpath, Shyam Nagar, Sodala, Jaipur, Rajasthan 302019</span>
              </li>
              <li>
                ...
                <span>+91 80057 70633 / +91 80055 66014</span>
              </li>
              <li>
      ...
      <div className="footer-bottom">
        <p>&copy; {year} Shri Kanchan Dialysis Centre. A Unit of Shri Krishan Kanchan Sewa Trust. All Rights Reserved.</p>
      </div>
    </footer>
  );
};
