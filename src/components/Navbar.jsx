  ...
  return (
    <header className="navbar-container">
      ...
      <div className="navbar-top">
        <div className="contact-info">
          ...
          <div className="contact-item">
            ...
            <a href="mailto:kanchandialysis@gmail.com" style={{ color: 'inherit', textDecoration: 'none' }}>kanchandialysis@gmail.com</a>
          </div>
        </div>
      ...
      <div className="navbar-bottom">
        <a href="#/" className="logo-container" onClick={() => setMenuOpen(false)}>
          <div className="logo-circle">
            <img src={logo} alt="Shri Kanchan Trust" className="logo-image" />
          </div>
          <span className="brand-name">Shri Kanchan</span>
        </a>
